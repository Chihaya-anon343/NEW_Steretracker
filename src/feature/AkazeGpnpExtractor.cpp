...
void AkazeGpnpExtractor::setTemplateData(const std::string& template_dir,
    ...
    // Use a separate full-scale AKAZE instance for template extraction
...
// ============================================================================
// Feature Extraction (migrated from StereoTracker::runPipeline)
// ============================================================================
...
PipelineResult AkazeGpnpExtractor::extract(const cv::Mat& left_gray,
    ...
    // Step 2: LK + FB (no MAD — moved to process() level)
    ...
    // Step 3: Stereo projection (requires initCamera to have been called)
    t0 = std::chrono::high_resolution_clock::now();
